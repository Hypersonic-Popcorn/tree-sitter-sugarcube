LANGUAGE_NAME := tree-sitter-tree-sitter-sugarcube
HOMEPAGE_URL := https://github.com/hypersonic-popcorn/tree-sitter-sugarcube
VERSION := 0.1.0
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/tree-sitter-sugarcube '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/tree-sitter-sugarcube
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/tree-sitter-sugarcube
